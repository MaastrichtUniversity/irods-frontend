...
RUN wget -P  /var/lib/tomcat8/webapps/ https://github.com/MaastrichtUniversity/irods-cloud-browser/releases/download/1.0.0-RELEASE-MUMC/irods-cloud-backend.war
